...
class AESSettings(BaseSettings):
    ...
    CEREBRAS_API_KEY: str | None = config("CEREBRAS_API_KEY", default=None)
    CEREBRAS_MODEL: str = config("CEREBRAS_MODEL", default="llama-3.3-70b")
    GITHUB_API_KEY: str | None = config("GITHUB_API_KEY", default=None)
    GITHUB_MODEL: str = config("GITHUB_MODEL", default="openai/gpt-4o-mini")
    ...
    AES_VISION_MODEL_ID: str = config("AES_VISION_MODEL_ID", default="us.xai.grok-4.6")
